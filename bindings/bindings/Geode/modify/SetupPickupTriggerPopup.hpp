...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPickupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupPickupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPickupTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPickupTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPickupTriggerPopup, updateState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPickupTriggerPopup, onPlusButton, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPickupTriggerPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
		}
	};
}
