...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSpawnParticlePopup> : ModifyBase<ModifyDerive<Der, SetupSpawnParticlePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSpawnParticlePopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSpawnParticlePopup, init, , EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
