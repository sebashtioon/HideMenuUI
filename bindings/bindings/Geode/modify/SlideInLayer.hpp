...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SlideInLayer> : ModifyBase<ModifyDerive<Der, SlideInLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, ccTouchBegan, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, ccTouchMoved, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, ccTouchEnded, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, enterLayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, exitLayer, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, showLayer, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, hideLayer, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, layerVisible, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, layerHidden, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, enterAnimFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, disableUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SlideInLayer, enableUI, )
		}
	};
}
