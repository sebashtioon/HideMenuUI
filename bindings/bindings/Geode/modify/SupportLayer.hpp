...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SupportLayer> : ModifyBase<ModifyDerive<Der, SupportLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49d0c0, Thiscall, SupportLayer, onLowDetail, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onPrivacy, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49cca0, Thiscall, SupportLayer, onRequestAccess, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49cef0, Thiscall, SupportLayer, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49d030, Thiscall, SupportLayer, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49ceb0, Thiscall, SupportLayer, onClosePopup, UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x49dcb0, Thiscall, SupportLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
