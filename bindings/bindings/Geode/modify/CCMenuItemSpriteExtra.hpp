...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCMenuItemSpriteExtra> : ModifyBase<ModifyDerive<Der, CCMenuItemSpriteExtra>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43cc0, Default, CCMenuItemSpriteExtra, create, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43d60, Thiscall, CCMenuItemSpriteExtra, init, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43ec0, Thiscall, CCMenuItemSpriteExtra, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43fd0, Thiscall, CCMenuItemSpriteExtra, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x441f0, Thiscall, CCMenuItemSpriteExtra, unselected, )
