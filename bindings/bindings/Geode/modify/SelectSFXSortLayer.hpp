...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectSFXSortLayer> : ModifyBase<ModifyDerive<Der, SelectSFXSortLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, create, , AudioSortType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, init, , AudioSortType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, onSelect, , cocos2d::CCObject*)
