...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCAlertCircle> : ModifyBase<ModifyDerive<Der, CCAlertCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCAlertCircle, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCAlertCircle, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCAlertCircle, draw, )
		}
	};
}
