...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomizeObjectSettingsPopup> : ModifyBase<ModifyDerive<Der, CustomizeObjectSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa8440, Thiscall, CustomizeObjectSettingsPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa8390, Thiscall, CustomizeObjectSettingsPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}
