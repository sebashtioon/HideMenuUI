...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelSettingsObject> : ModifyBase<ModifyDerive<Der, LevelSettingsObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d1e50, Default, LevelSettingsObject, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d2280, Thiscall, LevelSettingsObject, getSaveString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d3bb0, Default, LevelSettingsObject, objectFromDict, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(LevelSettingsObject, objectFromString, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d53d0, Thiscall, LevelSettingsObject, setupColorsFromLegacyMode, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(LevelSettingsObject, shouldUseYSection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d1f80, Thiscall, LevelSettingsObject, init, )
		}
	};
}
