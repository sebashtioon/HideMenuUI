...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPlatformerEndPopup> : ModifyBase<ModifyDerive<Der, SetupPlatformerEndPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPlatformerEndPopup, create, , EndTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPlatformerEndPopup, init, , EndTriggerGameObject*, cocos2d::CCArray*)
		}
	};
}
