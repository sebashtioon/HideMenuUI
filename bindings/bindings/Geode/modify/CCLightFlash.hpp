...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCLightFlash> : ModifyBase<ModifyDerive<Der, CCLightFlash>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42e00, Thiscall, CCLightFlash, cleanupFlash, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCLightFlash, fadeAndRemove, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42520, Thiscall, CCLightFlash, playEffect, cocos2d::CCPoint, cocos2d::ccColor3B, float, float, float, float, float, float, float, float, float, float, float, float, float, float, int, bool, bool, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42da0, Thiscall, CCLightFlash, removeLights, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42a60, Thiscall, CCLightFlash, showFlash, )
