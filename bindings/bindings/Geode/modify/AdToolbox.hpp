...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AdToolbox> : ModifyBase<ModifyDerive<Der, AdToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, cacheInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, cacheRewardedVideo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, disableBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, enableBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, enableBannerNoRefresh, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, hasCachedInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, hasCachedRewardedVideo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, isShowingAd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, queueRefreshBanner, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, setupAds, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, showDebug, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, showInterstitial, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AdToolbox, showRewardedVideo, )
		}
	};
}
