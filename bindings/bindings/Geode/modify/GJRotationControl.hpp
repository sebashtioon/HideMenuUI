...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotationControl> : ModifyBase<ModifyDerive<Der, GJRotationControl>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x125490, Thiscall, GJRotationControl, finishTouch, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x125370, Thiscall, GJRotationControl, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1257d0, Thiscall, GJRotationControl, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x125510, Thiscall, GJRotationControl, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x125610, Thiscall, GJRotationControl, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1257b0, Thiscall, GJRotationControl, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6fd20, Thiscall, GJRotationControl, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
		}
	};
}
