...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJItemIcon> : ModifyBase<ModifyDerive<Der, GJItemIcon>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2694c0, Thiscall, GJItemIcon, changeToLockedState, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x268880, Default, GJItemIcon, createBrowserItem, UnlockType, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x268750, Default, GJItemIcon, createStoreItem, UnlockType, int, bool, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2691d0, Thiscall, GJItemIcon, darkenStoreItem, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x269150, Thiscall, GJItemIcon, darkenStoreItem, ShopType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2689a0, Thiscall, GJItemIcon, init, UnlockType, int, cocos2d::ccColor3B, cocos2d::ccColor3B, bool, bool, bool, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2695a0, Thiscall, GJItemIcon, scaleForType, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x269400, Thiscall, GJItemIcon, toggleEnabledState, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJItemIcon, unlockedColorForType, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2690b0, Thiscall, GJItemIcon, setOpacity, unsigned char)
		}
	};
}
