...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ExtendedLayer> : ModifyBase<ModifyDerive<Der, ExtendedLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3de10, Thiscall, ExtendedLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3de30, Thiscall, ExtendedLayer, setPosition, cocos2d::CCPoint const&)
		}
	};
}
