...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GauntletLayer> : ModifyBase<ModifyDerive<Der, GauntletLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e93d0, Thiscall, GauntletLayer, init, GauntletType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eb5e0, Thiscall, GauntletLayer, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eaf60, Thiscall, GauntletLayer, onLevel, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e90b0, Default, GauntletLayer, scene, GauntletType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e9fd0, Thiscall, GauntletLayer, setupGauntlet, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eafd0, Thiscall, GauntletLayer, unlockActiveItem, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eb630, Thiscall, GauntletLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e9bc0, Thiscall, GauntletLayer, loadLevelsFinished, cocos2d::CCArray*, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e9dd0, Thiscall, GauntletLayer, loadLevelsFailed, char const*, int)
		}
	};
}
