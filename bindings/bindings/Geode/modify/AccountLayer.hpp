...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLayer> : ModifyBase<ModifyDerive<Der, AccountLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7bf70, Default, AccountLayer, create, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLayer, doBackup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLayer, doSync, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c9e0, Thiscall, AccountLayer, onBackup, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cfb0, Thiscall, AccountLayer, onHelp, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c820, Thiscall, AccountLayer, onLogin, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d0d0, Thiscall, AccountLayer, onMore, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c860, Thiscall, AccountLayer, onRegister, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7cd30, Thiscall, AccountLayer, onSync, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d130, Thiscall, AccountLayer, updatePage, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7c0d0, Thiscall, AccountLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7de20, Thiscall, AccountLayer, layerHidden, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d500, Thiscall, AccountLayer, backupAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d6b0, Thiscall, AccountLayer, backupAccountFailed, BackupAccountError, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d9c0, Thiscall, AccountLayer, syncAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7db80, Thiscall, AccountLayer, syncAccountFailed, BackupAccountError, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7d120, Thiscall, AccountLayer, accountStatusChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7dd10, Thiscall, AccountLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
