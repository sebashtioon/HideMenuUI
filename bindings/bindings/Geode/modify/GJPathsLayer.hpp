...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathsLayer> : ModifyBase<ModifyDerive<Der, GJPathsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272940, Default, GJPathsLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, darkenButtons, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2726d0, Default, GJPathsLayer, nameForPath, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x273190, Thiscall, GJPathsLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272fc0, Thiscall, GJPathsLayer, onPath, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272a40, Thiscall, GJPathsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x272f70, Thiscall, GJPathsLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2731f0, Thiscall, GJPathsLayer, keyBackClicked, )
