...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserMessage> : ModifyBase<ModifyDerive<Der, GJUserMessage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16b5f0, Default, GJUserMessage, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJUserMessage, create, , cocos2d::CCDictionary*)
