...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessagePopup> : ModifyBase<ModifyDerive<Der, GJMessagePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x285be0, Thiscall, GJMessagePopup, loadFromGJMessage, GJUserMessage*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286930, Thiscall, GJMessagePopup, downloadMessageFinished, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286980, Thiscall, GJMessagePopup, downloadMessageFailed, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2869c0, Thiscall, GJMessagePopup, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286b50, Thiscall, GJMessagePopup, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286c20, Thiscall, GJMessagePopup, onClosePopup, UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x286ca0, Thiscall, GJMessagePopup, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
