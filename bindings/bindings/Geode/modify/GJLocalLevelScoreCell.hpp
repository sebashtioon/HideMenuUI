...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLocalLevelScoreCell> : ModifyBase<ModifyDerive<Der, GJLocalLevelScoreCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb7360, Thiscall, GJLocalLevelScoreCell, loadFromScore, GJLocalScore*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJLocalLevelScoreCell, updateBGColor, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b9a0, Thiscall, GJLocalLevelScoreCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xabd00, Thiscall, GJLocalLevelScoreCell, draw, )
		}
	};
}
