...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ConfigureHSVWidget> : ModifyBase<ModifyDerive<Der, ConfigureHSVWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x95140, Default, ConfigureHSVWidget, create, cocos2d::ccHSVValue, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x95af0, Thiscall, ConfigureHSVWidget, createTextInputNode, cocos2d::CCPoint, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96890, Default, ConfigureHSVWidget, getHSV, GameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x95210, Thiscall, ConfigureHSVWidget, init, cocos2d::ccHSVValue, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ConfigureHSVWidget, onClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96300, Thiscall, ConfigureHSVWidget, onResetHSV, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96200, Thiscall, ConfigureHSVWidget, onToggleSConst, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96280, Thiscall, ConfigureHSVWidget, onToggleVConst, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x960e0, Thiscall, ConfigureHSVWidget, sliderChanged, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96380, Thiscall, ConfigureHSVWidget, updateLabels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96010, Thiscall, ConfigureHSVWidget, updateSliders, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ConfigureHSVWidget, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x89f80, Thiscall, ConfigureHSVWidget, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x95d50, Thiscall, ConfigureHSVWidget, textChanged, CCTextInputNode*)
		}
	};
}
