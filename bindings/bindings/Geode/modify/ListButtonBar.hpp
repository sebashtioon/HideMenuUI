...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ListButtonBar> : ModifyBase<ModifyDerive<Der, ListButtonBar>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x698f0, Default, ListButtonBar, create, cocos2d::CCArray*, cocos2d::CCPoint, int, int, float, float, float, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ListButtonBar, getPage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x69f00, Thiscall, ListButtonBar, goToPage, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x69a00, Thiscall, ListButtonBar, init, cocos2d::CCArray*, cocos2d::CCPoint, int, int, float, float, float, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x69fb0, Thiscall, ListButtonBar, onLeft, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x69f90, Thiscall, ListButtonBar, onRight, cocos2d::CCObject*)
		}
	};
}
