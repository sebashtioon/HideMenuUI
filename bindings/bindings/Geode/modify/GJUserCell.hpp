...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserCell> : ModifyBase<ModifyDerive<Der, GJUserCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb8300, Thiscall, GJUserCell, loadFromScore, GJUserScore*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb82e0, Thiscall, GJUserCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJUserCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9200, Thiscall, GJUserCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb95c0, Thiscall, GJUserCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9770, Thiscall, GJUserCell, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb9840, Thiscall, GJUserCell, onClosePopup, UploadActionPopup*)
		}
	};
}
