...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteGrayscale> : ModifyBase<ModifyDerive<Der, CCSpriteGrayscale>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, create, , gd::string const&, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, create, , gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, createWithSpriteFrame, , cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x481a0, Default, CCSpriteGrayscale, createWithSpriteFrameName, gd::string const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, createWithTexture, , cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, createWithTexture, , cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, getShaderName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteGrayscale, shaderBody, )
		}
	};
}
