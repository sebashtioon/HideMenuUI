...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DemonInfoPopup> : ModifyBase<ModifyDerive<Der, DemonInfoPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a3280, Default, DemonInfoPopup, create, int, int, int, int, int, int, int, int, int, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a2eb0, Default, DemonInfoPopup, createFromString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a33e0, Thiscall, DemonInfoPopup, init, int, int, int, int, int, int, int, int, int, int, int, int)
