...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCountPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCountPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, create, , CountTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, init, , CountTriggerGameObject*, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onTargetIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateCountTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateItemID, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f8340, Thiscall, SetupInstantCountPopup, textChanged, CCTextInputNode*)
		}
	};
}
