...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DialogLayer> : ModifyBase<ModifyDerive<Der, DialogLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd07e0, Thiscall, DialogLayer, addToMainScene, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd09b0, Thiscall, DialogLayer, animateInRandomSide, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcfcd0, Default, DialogLayer, createDialogLayer, DialogObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(DialogLayer, createWithObjects, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd02e0, Thiscall, DialogLayer, displayDialogObject, DialogObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0280, Thiscall, DialogLayer, displayNextObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, finishCurrentAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd06b0, Thiscall, DialogLayer, handleDialogTap, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcfe20, Thiscall, DialogLayer, init, DialogObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0850, Thiscall, DialogLayer, onClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, updateChatPlacement, , DialogChatPlacement)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0630, Thiscall, DialogLayer, updateNavButtonFrame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, onEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd08d0, Thiscall, DialogLayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(DialogLayer, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0900, Thiscall, DialogLayer, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0920, Thiscall, DialogLayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x51ee0, Thiscall, DialogLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0840, Thiscall, DialogLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0bf0, Thiscall, DialogLayer, keyDown, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0940, Thiscall, DialogLayer, fadeInTextFinished, TextArea*)
		}
	};
}
