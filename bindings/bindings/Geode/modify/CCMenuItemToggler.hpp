...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCMenuItemToggler> : ModifyBase<ModifyDerive<Der, CCMenuItemToggler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44360, Default, CCMenuItemToggler, create, cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44700, Thiscall, CCMenuItemToggler, normalTouch, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44720, Thiscall, CCMenuItemToggler, selectedTouch, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(CCMenuItemToggler, setSizeMult, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44740, Thiscall, CCMenuItemToggler, toggle, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44610, Thiscall, CCMenuItemToggler, activate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x445c0, Thiscall, CCMenuItemToggler, selected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44660, Thiscall, CCMenuItemToggler, unselected, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x446b0, Thiscall, CCMenuItemToggler, setEnabled, bool)
