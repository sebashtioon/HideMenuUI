...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPlayerControlPopup> : ModifyBase<ModifyDerive<Der, SetupPlayerControlPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPlayerControlPopup, create, , PlayerControlGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPlayerControlPopup, init, , PlayerControlGameObject*, cocos2d::CCArray*)
		}
	};
}
