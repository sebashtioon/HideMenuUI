...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJUserScore> : ModifyBase<ModifyDerive<Der, GJUserScore>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1688d0, Default, GJUserScore, create, cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x13d890, Thiscall, GJUserScore, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16a2c0, Thiscall, GJUserScore, isCurrentUser, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJUserScore, mergeWithScore, , GJUserScore*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16a270, Thiscall, GJUserScore, init, )
		}
	};
}
