...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCircleWave> : ModifyBase<ModifyDerive<Der, CCCircleWave>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41980, Default, CCCircleWave, create, float, float, float, bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41a30, Thiscall, CCCircleWave, init, float, float, float, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41cb0, Thiscall, CCCircleWave, updatePosition, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41c70, Thiscall, CCCircleWave, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42080, Thiscall, CCCircleWave, removeMeAndCleanup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41f50, Thiscall, CCCircleWave, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41cf0, Thiscall, CCCircleWave, updateTweenAction, float, char const*)
		}
	};
}
