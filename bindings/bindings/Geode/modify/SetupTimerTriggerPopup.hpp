...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTimerTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTimerTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTimerTriggerPopup, create, , TimerTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTimerTriggerPopup, init, , TimerTriggerGameObject*, cocos2d::CCArray*)
		}
	};
}
