...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadPopup> : ModifyBase<ModifyDerive<Der, UploadPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2eb740, Thiscall, UploadPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x464dc0, Thiscall, UploadPopup, levelUploadFinished, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x464f90, Thiscall, UploadPopup, levelUploadFailed, GJGameLevel*)
		}
	};
}
