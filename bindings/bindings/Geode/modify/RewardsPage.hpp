...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardsPage> : ModifyBase<ModifyDerive<Der, RewardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82fc0, Thiscall, RewardsPage, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9c20, Thiscall, RewardsPage, onFreeStuff, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9460, Thiscall, RewardsPage, onReward, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9810, Thiscall, RewardsPage, tryGetRewards, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardsPage, unlockLayerClosed, RewardUnlockLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9860, Thiscall, RewardsPage, updateTimers, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a8710, Thiscall, RewardsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41750, Thiscall, RewardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82ff0, Thiscall, RewardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a18c0, Thiscall, RewardsPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardsPage, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a95a0, Thiscall, RewardsPage, rewardsStatusFinished, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9790, Thiscall, RewardsPage, rewardsStatusFailed, )
		}
	};
}
