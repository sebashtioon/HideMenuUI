...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEnterEffectPopup> : ModifyBase<ModifyDerive<Der, SetupEnterEffectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f5180, Thiscall, SetupEnterEffectPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f5760, Thiscall, SetupEnterEffectPopup, onClose, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f5350, Thiscall, SetupEnterEffectPopup, valueDidChange, int, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3f5670, Thiscall, SetupEnterEffectPopup, hsvPopupClosed, HSVWidgetPopup*, cocos2d::ccHSVValue)
		}
	};
}
