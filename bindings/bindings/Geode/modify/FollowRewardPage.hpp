...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FollowRewardPage> : ModifyBase<ModifyDerive<Der, FollowRewardPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x135ab0, Default, FollowRewardPage, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82fc0, Thiscall, FollowRewardPage, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, onRewardedVideo, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x137a40, Thiscall, FollowRewardPage, onSpecialItem, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x138be0, Thiscall, FollowRewardPage, switchToOpenedState, CCMenuItemSpriteExtra*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x135bd0, Thiscall, FollowRewardPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41750, Thiscall, FollowRewardPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82ff0, Thiscall, FollowRewardPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x84fb0, Thiscall, FollowRewardPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x138cc0, Thiscall, FollowRewardPage, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x137a30, Thiscall, FollowRewardPage, rewardedVideoFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x137640, Thiscall, FollowRewardPage, updateRate, )
		}
	};
}
