...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerFireBoostSprite> : ModifyBase<ModifyDerive<Der, PlayerFireBoostSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x380cd0, Default, PlayerFireBoostSprite, create, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x380dd0, Thiscall, PlayerFireBoostSprite, loopFireAnimation, )
