...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommentUploadDelegate> : ModifyBase<ModifyDerive<Der, CommentUploadDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommentUploadDelegate, commentUploadFinished, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommentUploadDelegate, commentUploadFailed, , int, CommentError)
