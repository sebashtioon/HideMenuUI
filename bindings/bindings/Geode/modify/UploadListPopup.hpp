...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadListPopup> : ModifyBase<ModifyDerive<Der, UploadListPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2eaca0, Thiscall, UploadListPopup, init, GJLevelList*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2eb1e0, Thiscall, UploadListPopup, listUploadFinished, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2eb3b0, Thiscall, UploadListPopup, listUploadFailed, GJLevelList*, int)
		}
	};
}
