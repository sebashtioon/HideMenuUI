...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardUnlockLayer> : ModifyBase<ModifyDerive<Der, RewardUnlockLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9c50, Default, RewardUnlockLayer, create, int, RewardsPage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aab00, Thiscall, RewardUnlockLayer, connectionTimeout, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a9d80, Thiscall, RewardUnlockLayer, init, int, RewardsPage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardUnlockLayer, labelEnterFinishedO, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad200, Thiscall, RewardUnlockLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aab60, Thiscall, RewardUnlockLayer, playDropSound, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ac240, Thiscall, RewardUnlockLayer, playLabelEffect, int, int, cocos2d::CCSprite*, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aad20, Thiscall, RewardUnlockLayer, playRewardEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardUnlockLayer, readyToCollect, GJRewardItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ac1d0, Thiscall, RewardUnlockLayer, showCloseButton, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aaa40, Thiscall, RewardUnlockLayer, showCollectReward, GJRewardItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aac00, Thiscall, RewardUnlockLayer, step2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3aad00, Thiscall, RewardUnlockLayer, step3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardUnlockLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad1f0, Thiscall, RewardUnlockLayer, currencyWillExit, CurrencyRewardLayer*)
		}
	};
}
