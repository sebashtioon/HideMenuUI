...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomSongLayer> : ModifyBase<ModifyDerive<Der, CustomSongLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, create, , CustomSongDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, init, , CustomSongDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onCreateLines, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onMusicBrowser, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onNCSBrowser, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onNewgroundsBrowser, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onOptions, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, onSearch, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc1aa0, Thiscall, CustomSongLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomSongLayer, show, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc1830, Thiscall, CustomSongLayer, dropDownLayerWillClose, GJDropDownLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc1900, Thiscall, CustomSongLayer, musicBrowserClosed, MusicBrowser*)
		}
	};
}
