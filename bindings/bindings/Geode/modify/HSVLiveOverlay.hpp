...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, HSVLiveOverlay> : ModifyBase<ModifyDerive<Der, HSVLiveOverlay>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7a60, Thiscall, HSVLiveOverlay, closeColorSelect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7ae0, Thiscall, HSVLiveOverlay, createHSVWidget, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7860, Thiscall, HSVLiveOverlay, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a73c0, Thiscall, HSVLiveOverlay, init, GameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7ab0, Thiscall, HSVLiveOverlay, onSelectTab, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(HSVLiveOverlay, toggleControls, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7c80, Thiscall, HSVLiveOverlay, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8a220, Thiscall, HSVLiveOverlay, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a7cd0, Thiscall, HSVLiveOverlay, hsvChanged, ConfigureHSVWidget*)
		}
	};
}
