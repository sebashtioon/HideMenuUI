...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLabelBMFont> : ModifyBase<ModifyDerive<Der, cocos2d::CCLabelBMFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCLabelBMFont@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCLabelBMFont, )
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCLabelBMFont@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCLabelBMFont)
