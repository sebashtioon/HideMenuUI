...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareCommentLayer> : ModifyBase<ModifyDerive<Der, ShareCommentLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x460fe0, Default, ShareCommentLayer, create, gd::string, int, CommentType, int, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4611f0, Thiscall, ShareCommentLayer, init, gd::string, int, CommentType, int, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, onClear, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, onPercent, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462440, Thiscall, ShareCommentLayer, onShare, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, updateCharCountLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, updateDescText, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, updatePercentLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareCommentLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462820, Thiscall, ShareCommentLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ShareCommentLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462870, Thiscall, ShareCommentLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4629b0, Thiscall, ShareCommentLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462c00, Thiscall, ShareCommentLayer, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462c90, Thiscall, ShareCommentLayer, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x462d40, Thiscall, ShareCommentLayer, onClosePopup, UploadActionPopup*)
		}
	};
}
