...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MenuGameLayer> : ModifyBase<ModifyDerive<Der, MenuGameLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3129e0, Thiscall, MenuGameLayer, destroyPlayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x311340, Thiscall, MenuGameLayer, getBGColor, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x311db0, Thiscall, MenuGameLayer, resetPlayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x311610, Thiscall, MenuGameLayer, tryJump, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3111f0, Thiscall, MenuGameLayer, updateColor, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuGameLayer, updateColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3118e0, Thiscall, MenuGameLayer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x310ac0, Thiscall, MenuGameLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x312c60, Thiscall, MenuGameLayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6fd20, Thiscall, MenuGameLayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x312e10, Thiscall, MenuGameLayer, registerWithTouchDispatcher, )
		}
	};
}
