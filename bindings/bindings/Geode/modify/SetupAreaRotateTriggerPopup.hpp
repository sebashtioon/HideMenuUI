...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaRotateTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaRotateTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAreaRotateTriggerPopup, create, , EnterEffectObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAreaRotateTriggerPopup, init, , EnterEffectObject*, cocos2d::CCArray*)
		}
	};
}
