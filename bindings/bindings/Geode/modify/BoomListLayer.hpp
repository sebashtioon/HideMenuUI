...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BoomListLayer> : ModifyBase<ModifyDerive<Der, BoomListLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(BoomListLayer, create, , BoomListView*, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(BoomListLayer, init, , BoomListView*, char const*)
		}
	};
}
