...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommunityCreditsPage> : ModifyBase<ModifyDerive<Der, CommunityCreditsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x94830, Thiscall, CommunityCreditsPage, goToPage, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82fc0, Thiscall, CommunityCreditsPage, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x947f0, Thiscall, CommunityCreditsPage, onSwitchPage, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x927f0, Thiscall, CommunityCreditsPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41750, Thiscall, CommunityCreditsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x82ff0, Thiscall, CommunityCreditsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x94950, Thiscall, CommunityCreditsPage, show, )
		}
	};
}
