...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetLevelOrderPopup> : ModifyBase<ModifyDerive<Der, SetLevelOrderPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetLevelOrderPopup, create, , int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetLevelOrderPopup, init, , int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetLevelOrderPopup, onOrderButton, , cocos2d::CCObject*)
		}
	};
}
