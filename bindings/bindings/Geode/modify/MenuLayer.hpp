...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MenuLayer> : ModifyBase<ModifyDerive<Der, MenuLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x312f60, Default, MenuLayer, scene, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315a30, Thiscall, MenuLayer, endGame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314950, Thiscall, MenuLayer, firstNetworkTest, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314e80, Thiscall, MenuLayer, onAchievements, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315390, Thiscall, MenuLayer, onCreator, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314700, Thiscall, MenuLayer, onDaily, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314d80, Thiscall, MenuLayer, onDiscord, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(MenuLayer, onEveryplay, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314d00, Thiscall, MenuLayer, onFacebook, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315420, Thiscall, MenuLayer, onGarage, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onGooglePlayGames, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314da0, Thiscall, MenuLayer, onMoreGames, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314c40, Thiscall, MenuLayer, onMyProfile, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3154b0, Thiscall, MenuLayer, onNewgrounds, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3150d0, Thiscall, MenuLayer, onOptions, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3150e0, Thiscall, MenuLayer, onOptionsInstant, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315030, Thiscall, MenuLayer, onPlay, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3155f0, Thiscall, MenuLayer, onQuit, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314ce0, Thiscall, MenuLayer, onRobTop, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315270, Thiscall, MenuLayer, onStats, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MenuLayer, onTrailer, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314d60, Thiscall, MenuLayer, onTwitch, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314d20, Thiscall, MenuLayer, onTwitter, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314d40, Thiscall, MenuLayer, onYouTube, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3150f0, Thiscall, MenuLayer, openOptions, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314b20, Thiscall, MenuLayer, showTOS, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314850, Thiscall, MenuLayer, updateUserProfileButton, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x315710, Thiscall, MenuLayer, willClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3130f0, Thiscall, MenuLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3155e0, Thiscall, MenuLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3159c0, Thiscall, MenuLayer, keyDown, cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314fe0, Thiscall, MenuLayer, googlePlaySignedIn, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3157b0, Thiscall, MenuLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
