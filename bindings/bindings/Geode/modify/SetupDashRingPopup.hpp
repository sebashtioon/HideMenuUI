...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupDashRingPopup> : ModifyBase<ModifyDerive<Der, SetupDashRingPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupDashRingPopup, create, , DashRingObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupDashRingPopup, init, , DashRingObject*, cocos2d::CCArray*)
		}
	};
}
