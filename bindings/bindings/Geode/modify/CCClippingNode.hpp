...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCClippingNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCClippingNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCClippingNode@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCClippingNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCClippingNode@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCClippingNode)
