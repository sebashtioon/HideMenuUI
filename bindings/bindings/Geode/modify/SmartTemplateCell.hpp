...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SmartTemplateCell> : ModifyBase<ModifyDerive<Der, SmartTemplateCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xbbc50, Thiscall, SmartTemplateCell, loadFromObject, GJSmartTemplate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SmartTemplateCell, onClick, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xbc040, Thiscall, SmartTemplateCell, updateBGColor, int)
