...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StarInfoPopup> : ModifyBase<ModifyDerive<Der, StarInfoPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a42a0, Default, StarInfoPopup, create, int, int, int, int, int, int, int, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a3d10, Default, StarInfoPopup, createFromString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a3ff0, Default, StarInfoPopup, createFromStringMoons, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3a43e0, Thiscall, StarInfoPopup, init, int, int, int, int, int, int, int, int, int, bool)
