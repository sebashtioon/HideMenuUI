...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameEffectsManager> : ModifyBase<ModifyDerive<Der, GameEffectsManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameEffectsManager, create, , PlayLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameEffectsManager, addParticleEffect, , cocos2d::CCParticleSystemQuad*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameEffectsManager, init, , PlayLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameEffectsManager, scaleParticle, , cocos2d::CCParticleSystemQuad*, float)
		}
	};
}
