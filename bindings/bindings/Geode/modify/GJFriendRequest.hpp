...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFriendRequest> : ModifyBase<ModifyDerive<Der, GJFriendRequest>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFriendRequest, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFriendRequest, create, , cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFriendRequest, init, )
		}
	};
}
