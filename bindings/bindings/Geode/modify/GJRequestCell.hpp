...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRequestCell> : ModifyBase<ModifyDerive<Der, GJRequestCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xb99d0, Thiscall, GJRequestCell, loadFromScore, GJUserScore*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xba580, Thiscall, GJRequestCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xba730, Thiscall, GJRequestCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xba910, Thiscall, GJRequestCell, uploadActionFailed, int, int)
