...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LoadingCircle> : ModifyBase<ModifyDerive<Der, LoadingCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a3c0, Default, LoadingCircle, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a6a0, Thiscall, LoadingCircle, fadeAndRemove, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a5a0, Thiscall, LoadingCircle, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(LoadingCircle, setFade, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a4c0, Thiscall, LoadingCircle, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a740, Thiscall, LoadingCircle, draw, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a760, Thiscall, LoadingCircle, registerWithTouchDispatcher, )
		}
	};
}
