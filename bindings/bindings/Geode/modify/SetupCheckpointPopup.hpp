...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCheckpointPopup> : ModifyBase<ModifyDerive<Der, SetupCheckpointPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCheckpointPopup, create, , CheckpointGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCheckpointPopup, init, , CheckpointGameObject*, cocos2d::CCArray*)
		}
	};
}
