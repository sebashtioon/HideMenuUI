...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AnimatedShopKeeper> : ModifyBase<ModifyDerive<Der, AnimatedShopKeeper>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d5f0, Thiscall, AnimatedShopKeeper, playReactAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d880, Thiscall, AnimatedShopKeeper, startAnimating, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d910, Thiscall, AnimatedShopKeeper, animationFinished, char const*)
		}
	};
}
