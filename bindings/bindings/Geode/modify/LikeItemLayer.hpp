...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LikeItemLayer> : ModifyBase<ModifyDerive<Der, LikeItemLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d400, Default, LikeItemLayer, create, LikeItemType, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d500, Thiscall, LikeItemLayer, init, LikeItemType, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LikeItemLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d8e0, Thiscall, LikeItemLayer, onDislike, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d8d0, Thiscall, LikeItemLayer, onLike, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30d8f0, Thiscall, LikeItemLayer, triggerLike, bool)
