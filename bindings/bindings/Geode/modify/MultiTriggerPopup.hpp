...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultiTriggerPopup> : ModifyBase<ModifyDerive<Der, MultiTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
