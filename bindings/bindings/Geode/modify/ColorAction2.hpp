...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorAction2> : ModifyBase<ModifyDerive<Der, ColorAction2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ColorAction2, resetAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ColorAction2, step, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ColorAction2, updateCustomColor, , cocos2d::ccColor3B, cocos2d::ccColor3B)
		}
	};
}
