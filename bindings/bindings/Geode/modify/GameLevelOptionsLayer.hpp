...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameLevelOptionsLayer> : ModifyBase<ModifyDerive<Der, GameLevelOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28e750, Default, GameLevelOptionsLayer, create, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelOptionsLayer, init, , GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28e8b0, Thiscall, GameLevelOptionsLayer, setupOptions, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28e930, Thiscall, GameLevelOptionsLayer, didToggle, int)
		}
	};
}
