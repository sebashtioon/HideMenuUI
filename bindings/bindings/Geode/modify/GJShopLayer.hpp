...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJShopLayer> : ModifyBase<ModifyDerive<Der, GJShopLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x297400, Thiscall, GJShopLayer, init, ShopType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29a840, Thiscall, GJShopLayer, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x299680, Thiscall, GJShopLayer, onCommunityCredits, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJShopLayer, onPlushies, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x299850, Thiscall, GJShopLayer, onSelectItem, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJShopLayer, onVideoAd, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x297280, Default, GJShopLayer, scene, ShopType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2999d0, Thiscall, GJShopLayer, showCantAffordMessage, GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29aa70, Thiscall, GJShopLayer, showReactMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x299820, Thiscall, GJShopLayer, updateCurrencyCounter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x299400, Thiscall, GJShopLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29c3c0, Thiscall, GJShopLayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6fd20, Thiscall, GJShopLayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x41750, Thiscall, GJShopLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29aa60, Thiscall, GJShopLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29a0a0, Thiscall, GJShopLayer, didPurchaseItem, GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2997c0, Thiscall, GJShopLayer, rewardedVideoFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29c0c0, Thiscall, GJShopLayer, dialogClosed, DialogLayer*)
		}
	};
}
