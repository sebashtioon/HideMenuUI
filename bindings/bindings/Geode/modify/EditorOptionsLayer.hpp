...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorOptionsLayer> : ModifyBase<ModifyDerive<Der, EditorOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27f4f0, Thiscall, EditorOptionsLayer, onButtonRows, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27f460, Thiscall, EditorOptionsLayer, onButtonsPerRow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27eb50, Thiscall, EditorOptionsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27f580, Thiscall, EditorOptionsLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27eb80, Thiscall, EditorOptionsLayer, setupOptions, )
		}
	};
}
