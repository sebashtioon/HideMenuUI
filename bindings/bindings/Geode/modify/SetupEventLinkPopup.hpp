...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEventLinkPopup> : ModifyBase<ModifyDerive<Der, SetupEventLinkPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEventLinkPopup, create, , EventLinkTrigger*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEventLinkPopup, init, , EventLinkTrigger*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEventLinkPopup, onSelectEvent, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEventLinkPopup, updateEventIDs, , gd::set<int>&)
		}
	};
}
