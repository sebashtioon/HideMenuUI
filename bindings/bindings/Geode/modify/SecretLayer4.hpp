...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer4> : ModifyBase<ModifyDerive<Der, SecretLayer4>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ca010, Thiscall, SecretLayer4, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3cdb70, Thiscall, SecretLayer4, keyBackClicked, )
