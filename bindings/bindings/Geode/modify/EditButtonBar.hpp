...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditButtonBar> : ModifyBase<ModifyDerive<Der, EditButtonBar>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0cb0, Default, EditButtonBar, create, cocos2d::CCArray*, cocos2d::CCPoint, int, bool, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0e10, Thiscall, EditButtonBar, loadFromItems, cocos2d::CCArray*, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd1800, Thiscall, EditButtonBar, onLeft, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd1790, Thiscall, EditButtonBar, onRight, cocos2d::CCObject*)
