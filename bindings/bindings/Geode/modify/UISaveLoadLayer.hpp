...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UISaveLoadLayer> : ModifyBase<ModifyDerive<Der, UISaveLoadLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UISaveLoadLayer, create, , UIOptionsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UISaveLoadLayer, init, , UIOptionsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UISaveLoadLayer, onLoad, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UISaveLoadLayer, onSave, , cocos2d::CCObject*)
		}
	};
}
