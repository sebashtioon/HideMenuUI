...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSFXEditPopup> : ModifyBase<ModifyDerive<Der, SetupSFXEditPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSFXEditPopup, create, , SFXTriggerGameObject*, cocos2d::CCArray*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSFXEditPopup, init, , SFXTriggerGameObject*, cocos2d::CCArray*, bool)
		}
	};
}
