...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJDifficultySprite> : ModifyBase<ModifyDerive<Der, GJDifficultySprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x292c60, Default, GJDifficultySprite, create, int, GJDifficultyName)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x292d40, Default, GJDifficultySprite, getDifficultyFrame, int, GJDifficultyName)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJDifficultySprite, init, , int, GJDifficultyName)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x292e20, Thiscall, GJDifficultySprite, updateDifficultyFrame, int, GJDifficultyName)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x292f40, Thiscall, GJDifficultySprite, updateFeatureState, GJFeatureState)
