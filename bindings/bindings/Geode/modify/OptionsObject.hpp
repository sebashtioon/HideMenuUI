...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OptionsObject> : ModifyBase<ModifyDerive<Der, OptionsObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsObject, create, , int, bool, gd::string, OptionsObjectDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsObject, init, , int, bool, gd::string, OptionsObjectDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsObject, toggleState, )
		}
	};
}
