...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CheckpointGameObject> : ModifyBase<ModifyDerive<Der, CheckpointGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, init, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48d630, Thiscall, CheckpointGameObject, triggerObject, GJBaseGameLayer*, int, gd::vector<int> const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48d650, Thiscall, CheckpointGameObject, triggerActivated, float)
