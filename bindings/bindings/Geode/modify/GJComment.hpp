...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJComment> : ModifyBase<ModifyDerive<Der, GJComment>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJComment, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJComment, create, , cocos2d::CCDictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJComment, init, )
		}
	};
}
