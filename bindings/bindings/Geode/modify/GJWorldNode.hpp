...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJWorldNode> : ModifyBase<ModifyDerive<Der, GJWorldNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, create, , int, WorldSelectLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, addDotsToLevel, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, dotPositionForLevel, , int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, init, , int, WorldSelectLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, onLevel, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, playStep1, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, playStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, playStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, positionForLevelButton, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJWorldNode, unlockActiveItem, )
		}
	};
}
