...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ButtonSprite> : ModifyBase<ModifyDerive<Der, ButtonSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x3dea0, Thiscall, ButtonSprite, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e2d0, Default, ButtonSprite, create, char const*, int, int, float, bool, char const*, char const*, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3dfc0, Default, ButtonSprite, create, cocos2d::CCSprite*, int, int, float, float, bool, char const*, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e3a0, Thiscall, ButtonSprite, init, char const*, int, int, float, bool, char const*, char const*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e070, Thiscall, ButtonSprite, init, cocos2d::CCSprite*, int, int, float, float, bool, char const*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ButtonSprite, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ec60, Thiscall, ButtonSprite, setString, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e6a0, Thiscall, ButtonSprite, updateBGImage, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e7e0, Thiscall, ButtonSprite, updateSpriteBGSize, )
