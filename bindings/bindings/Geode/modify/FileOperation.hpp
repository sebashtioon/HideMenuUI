...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FileOperation> : ModifyBase<ModifyDerive<Der, FileOperation>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FileOperation, getFilePath, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FileOperation, readFile, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FileOperation, saveFile, )
		}
	};
}
