...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DailyLevelPage> : ModifyBase<ModifyDerive<Der, DailyLevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcb380, Default, DailyLevelPage, create, GJTimedLevelType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xce4c0, Thiscall, DailyLevelPage, claimLevelReward, DailyLevelNode*, GJGameLevel*, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcd130, Thiscall, DailyLevelPage, createDailyNode, GJGameLevel*, bool, float, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcd4f0, Thiscall, DailyLevelPage, getDailyTimeString, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcb4c0, Thiscall, DailyLevelPage, init, GJTimedLevelType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x85150, Thiscall, DailyLevelPage, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xce960, Thiscall, DailyLevelPage, onTheSafe, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xccf00, Thiscall, DailyLevelPage, tryGetDailyStatus, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xce170, Thiscall, DailyLevelPage, updateTimers, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xccb90, Thiscall, DailyLevelPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(DailyLevelPage, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcc8d0, Thiscall, DailyLevelPage, dailyStatusFinished, GJTimedLevelType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xccb90, Thiscall, DailyLevelPage, dailyStatusFailed, GJTimedLevelType, GJErrorCode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xcce80, Thiscall, DailyLevelPage, levelDownloadFinished, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xccee0, Thiscall, DailyLevelPage, levelDownloadFailed, int)
		}
	};
}
