...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OBB2D> : ModifyBase<ModifyDerive<Der, OBB2D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6c390, Default, OBB2D, create, cocos2d::CCPoint, float, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6c560, Thiscall, OBB2D, calculateWithCenter, cocos2d::CCPoint, float, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6c880, Thiscall, OBB2D, orderCorners, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OBB2D, overlaps, , OBB2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6cc10, Thiscall, OBB2D, overlaps1Way, OBB2D*)
		}
	};
}
