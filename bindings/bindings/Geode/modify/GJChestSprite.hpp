...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJChestSprite> : ModifyBase<ModifyDerive<Der, GJChestSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad250, Default, GJChestSprite, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJChestSprite, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad450, Thiscall, GJChestSprite, switchToState, ChestSpriteState, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad3e0, Thiscall, GJChestSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ad320, Thiscall, GJChestSprite, setColor, cocos2d::ccColor3B const&)
		}
	};
}
