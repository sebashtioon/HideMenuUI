...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathPage> : ModifyBase<ModifyDerive<Der, GJPathPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x273250, Default, GJPathPage, create, int, GJPathsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x273380, Thiscall, GJPathPage, init, int, GJPathsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x274ed0, Thiscall, GJPathPage, onActivatePath, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276b80, Thiscall, GJPathPage, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x274f00, Thiscall, GJPathPage, onIconInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x275100, Thiscall, GJPathPage, onUnlock, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x275950, Thiscall, GJPathPage, playUnlockAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x275280, Thiscall, GJPathPage, showCantAffordMessage, GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276a90, Thiscall, GJPathPage, unlockAnimationFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x275fa0, Thiscall, GJPathPage, unlockAnimationStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276220, Thiscall, GJPathPage, unlockAnimationStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276c20, Thiscall, GJPathPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2750f0, Thiscall, GJPathPage, didPurchaseItem, GJStoreItem*)
		}
	};
}
