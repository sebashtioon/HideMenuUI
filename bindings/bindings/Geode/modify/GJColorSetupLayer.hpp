...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJColorSetupLayer> : ModifyBase<ModifyDerive<Der, GJColorSetupLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, create, , LevelSettingsObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, init, , LevelSettingsObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, onColor, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, onPage, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, showPage, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, updateSpriteColor, , ColorChannelSprite*, cocos2d::CCLabelBMFont*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJColorSetupLayer, updateSpriteColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2453e0, Thiscall, GJColorSetupLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x245310, Thiscall, GJColorSetupLayer, colorSelectClosed, cocos2d::CCNode*)
		}
	};
}
