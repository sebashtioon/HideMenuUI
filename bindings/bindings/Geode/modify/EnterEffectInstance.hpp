...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnterEffectInstance> : ModifyBase<ModifyDerive<Der, EnterEffectInstance>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, animateValue, , int, float, float, float, int, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, getValue, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, loadTransitions, , EnterEffectObject*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, loadValuesFromObject, , EnterEffectObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, setValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EnterEffectInstance, updateTransitions, , float, GJBaseGameLayer*)
		}
	};
}
