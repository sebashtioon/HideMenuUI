...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCLightStrip> : ModifyBase<ModifyDerive<Der, CCLightStrip>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42e30, Thiscall, CCLightStrip, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x42ff0, Thiscall, CCLightStrip, updateTweenAction, float, char const*)
		}
	};
}
