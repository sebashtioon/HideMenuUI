...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer2> : ModifyBase<ModifyDerive<Der, SecretLayer2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c22a0, Thiscall, SecretLayer2, getBasicMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c2e00, Thiscall, SecretLayer2, getErrorMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c19d0, Thiscall, SecretLayer2, getMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c1bb0, Thiscall, SecretLayer2, getThreadMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, nodeWithTag, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c3f00, Thiscall, SecretLayer2, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bf060, Thiscall, SecretLayer2, onDoor, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bede0, Thiscall, SecretLayer2, onSecretLevel, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bf9c0, Thiscall, SecretLayer2, onSubmit, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c3a80, Thiscall, SecretLayer2, playCoinEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bc910, Default, SecretLayer2, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, selectAThread, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3be090, Thiscall, SecretLayer2, showCompletedLevel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bdf20, Thiscall, SecretLayer2, showSecretLevel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c1940, Thiscall, SecretLayer2, updateMessageLabel, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c1650, Thiscall, SecretLayer2, updateSearchLabel, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bca90, Thiscall, SecretLayer2, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c3fc0, Thiscall, SecretLayer2, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c3fb0, Thiscall, SecretLayer2, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c1430, Thiscall, SecretLayer2, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3c1580, Thiscall, SecretLayer2, textInputClosed, CCTextInputNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bed40, Thiscall, SecretLayer2, dialogClosed, DialogLayer*)
		}
	};
}
