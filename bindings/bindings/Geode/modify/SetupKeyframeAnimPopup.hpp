...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupKeyframeAnimPopup> : ModifyBase<ModifyDerive<Der, SetupKeyframeAnimPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupKeyframeAnimPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupKeyframeAnimPopup, init, , EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
