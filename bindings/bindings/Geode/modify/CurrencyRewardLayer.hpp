...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CurrencyRewardLayer> : ModifyBase<ModifyDerive<Der, CurrencyRewardLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9dd30, Default, CurrencyRewardLayer, create, int, int, int, int, CurrencySpriteType, int, CurrencySpriteType, int, cocos2d::CCPoint, CurrencyRewardType, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9fc00, Thiscall, CurrencyRewardLayer, createObjectsFull, CurrencySpriteType, int, cocos2d::CCSprite*, cocos2d::CCPoint, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9df80, Thiscall, CurrencyRewardLayer, init, int, int, int, int, CurrencySpriteType, int, CurrencySpriteType, int, cocos2d::CCPoint, CurrencyRewardType, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa12c0, Thiscall, CurrencyRewardLayer, pulseSprite, cocos2d::CCSprite*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa08f0, Thiscall, CurrencyRewardLayer, update, float)
		}
	};
}
