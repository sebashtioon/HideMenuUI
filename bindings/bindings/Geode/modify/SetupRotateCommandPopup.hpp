...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotateCommandPopup> : ModifyBase<ModifyDerive<Der, SetupRotateCommandPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, onInfiniteDuration, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, updateControlVisibility, )
