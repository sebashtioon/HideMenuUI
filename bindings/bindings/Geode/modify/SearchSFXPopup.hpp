...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SearchSFXPopup> : ModifyBase<ModifyDerive<Der, SearchSFXPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SearchSFXPopup, create, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SearchSFXPopup, init, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SearchSFXPopup, onSearchFolders, , cocos2d::CCObject*)
		}
	};
}
