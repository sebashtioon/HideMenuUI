...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SearchButton> : ModifyBase<ModifyDerive<Der, SearchButton>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f21f0, Default, SearchButton, create, char const*, char const*, float, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f22c0, Thiscall, SearchButton, init, char const*, char const*, float, char const*)
		}
	};
}
