...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DemonFilterSelectLayer> : ModifyBase<ModifyDerive<Der, DemonFilterSelectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f79c0, Thiscall, DemonFilterSelectLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f7900, Thiscall, DemonFilterSelectLayer, selectRating, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f72c0, Thiscall, DemonFilterSelectLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f7a10, Thiscall, DemonFilterSelectLayer, keyBackClicked, )
		}
	};
}
