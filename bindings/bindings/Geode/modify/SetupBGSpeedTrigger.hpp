...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupBGSpeedTrigger> : ModifyBase<ModifyDerive<Der, SetupBGSpeedTrigger>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupBGSpeedTrigger, create, , EffectGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupBGSpeedTrigger, init, , EffectGameObject*, cocos2d::CCArray*, int)
		}
	};
}
