...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ef7c0, Thiscall, SetupInstantCollisionTriggerPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3ef590, Thiscall, SetupInstantCollisionTriggerPopup, valueDidChange, int, float)
		}
	};
}
