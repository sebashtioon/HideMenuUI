...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareListLayer> : ModifyBase<ModifyDerive<Der, ShareListLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, create, , GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, init, , GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, onInfo, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, onShare, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, onUnlisted, , cocos2d::CCObject*)
