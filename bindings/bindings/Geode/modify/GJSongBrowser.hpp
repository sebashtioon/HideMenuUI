...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSongBrowser> : ModifyBase<ModifyDerive<Der, GJSongBrowser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a4b80, Default, GJSongBrowser, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a5180, Thiscall, GJSongBrowser, loadPage, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a5430, Thiscall, GJSongBrowser, onDeleteAll, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a5410, Thiscall, GJSongBrowser, onNextPage, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a5420, Thiscall, GJSongBrowser, onPrevPage, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a4d00, Thiscall, GJSongBrowser, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a4e00, Thiscall, GJSongBrowser, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, exitLayer, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a5540, Thiscall, GJSongBrowser, FLAlert_Clicked, FLAlertLayer*, bool)
