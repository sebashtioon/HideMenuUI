...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTimerEventTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTimerEventTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTimerEventTriggerPopup, create, , TimerTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTimerEventTriggerPopup, init, , TimerTriggerGameObject*, cocos2d::CCArray*)
		}
	};
}
