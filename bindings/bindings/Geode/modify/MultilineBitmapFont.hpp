...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultilineBitmapFont> : ModifyBase<ModifyDerive<Der, MultilineBitmapFont>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a9b0, Thiscall, MultilineBitmapFont, initWithFont, char const*, gd::string, float, float, cocos2d::CCPoint, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6bbb0, Thiscall, MultilineBitmapFont, moveSpecialDescriptors, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6b2e0, Thiscall, MultilineBitmapFont, readColorInfo, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6bc40, Thiscall, MultilineBitmapFont, stringWithMaxWidth, gd::string, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6b260, Thiscall, MultilineBitmapFont, setOpacity, unsigned char)
		}
	};
}
