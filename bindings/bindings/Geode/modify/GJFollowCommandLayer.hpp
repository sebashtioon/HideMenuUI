...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFollowCommandLayer> : ModifyBase<ModifyDerive<Der, GJFollowCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x25e810, Thiscall, GJFollowCommandLayer, init, EffectGameObject*, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x260230, Thiscall, GJFollowCommandLayer, textChanged, CCTextInputNode*)
		}
	};
}
