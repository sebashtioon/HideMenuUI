...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPersistentItemTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupPersistentItemTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPersistentItemTriggerPopup, create, , ItemTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPersistentItemTriggerPopup, init, , ItemTriggerGameObject*, cocos2d::CCArray*)
		}
	};
}
