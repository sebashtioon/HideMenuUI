...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathSprite> : ModifyBase<ModifyDerive<Der, GJPathSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276c30, Default, GJPathSprite, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathSprite, addRankLabel, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x277240, Thiscall, GJPathSprite, addShardSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276f80, Thiscall, GJPathSprite, changeToLockedArt, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathSprite, init, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x276e00, Thiscall, GJPathSprite, updateState, )
		}
	};
}
