...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectControlPopup> : ModifyBase<ModifyDerive<Der, SetupObjectControlPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupObjectControlPopup, create, , ObjectControlGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupObjectControlPopup, init, , ObjectControlGameObject*, cocos2d::CCArray*)
		}
	};
}
