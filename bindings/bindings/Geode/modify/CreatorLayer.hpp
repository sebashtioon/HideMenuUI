...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CreatorLayer> : ModifyBase<ModifyDerive<Der, CreatorLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9a190, Default, CreatorLayer, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreatorLayer, canPlayOnlineLevels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d810, Thiscall, CreatorLayer, checkQuestsStatus, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c3a0, Thiscall, CreatorLayer, onAdventureMap, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d9c0, Thiscall, CreatorLayer, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c770, Thiscall, CreatorLayer, onChallenge, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c510, Thiscall, CreatorLayer, onDailyLevel, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c550, Thiscall, CreatorLayer, onEventLevel, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreatorLayer, onFameLevels, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9ba60, Thiscall, CreatorLayer, onFeaturedLevels, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bd50, Thiscall, CreatorLayer, onGauntlets, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9b8b0, Thiscall, CreatorLayer, onLeaderboards, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bc90, Thiscall, CreatorLayer, onMapPacks, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bdd0, Thiscall, CreatorLayer, onMultiplayer, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9b4a0, Thiscall, CreatorLayer, onMyLevels, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bc10, Thiscall, CreatorLayer, onOnlineLevels, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreatorLayer, onOnlyFullVersion, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bb20, Thiscall, CreatorLayer, onPaths, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9b6b0, Thiscall, CreatorLayer, onSavedLevels, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c8e0, Thiscall, CreatorLayer, onSecretVault, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9bb40, Thiscall, CreatorLayer, onTopLists, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9cfc0, Thiscall, CreatorLayer, onTreasureRoom, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9c530, Thiscall, CreatorLayer, onWeeklyLevel, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9a300, Thiscall, CreatorLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9dae0, Thiscall, CreatorLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9da20, Thiscall, CreatorLayer, sceneWillResume, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x9d900, Thiscall, CreatorLayer, dialogClosed, DialogLayer*)
		}
	};
}
