...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMapObject> : ModifyBase<ModifyDerive<Der, GJMapObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, create, , cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, createMonster, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, init, , cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, monsterIdle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, monsterJump, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, moveFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, moveMonster, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, moveMonster, , cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, playerJump, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, setObjectOrigin, , cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, startMonsterJumpLoop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, startPlayerJumpLoop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, touchMonster, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMapObject, updateShadow, , float, float, cocos2d::CCPoint)
		}
	};
}
