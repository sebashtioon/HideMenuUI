...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLoginLayer> : ModifyBase<ModifyDerive<Der, AccountLoginLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, create, , gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, init, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, onForgotPassword, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, onForgotUser, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b5d0, Thiscall, AccountLoginLayer, onSubmit, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b9b0, Thiscall, AccountLoginLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b560, Thiscall, AccountLoginLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(AccountLoginLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7ba80, Thiscall, AccountLoginLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(AccountLoginLayer, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b150, Thiscall, AccountLoginLayer, loginAccountFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b3a0, Thiscall, AccountLoginLayer, loginAccountFailed, AccountError)
		}
	};
}
