...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BonusDropdown> : ModifyBase<ModifyDerive<Der, BonusDropdown>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(BonusDropdown, create, , gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(BonusDropdown, init, , gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(BonusDropdown, show, )
		}
	};
}
