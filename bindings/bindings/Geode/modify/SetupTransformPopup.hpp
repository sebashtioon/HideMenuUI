...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTransformPopup> : ModifyBase<ModifyDerive<Der, SetupTransformPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTransformPopup, create, , TransformTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTransformPopup, init, , TransformTriggerGameObject*, cocos2d::CCArray*)
		}
	};
}
