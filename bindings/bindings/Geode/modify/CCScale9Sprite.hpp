...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCScale9Sprite> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCScale9Sprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCScale9Sprite@extension@cocos2d@@QAE@XZ")), Thiscall, cocos2d::extension::CCScale9Sprite, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCScale9Sprite@extension@cocos2d@@UAE@XZ")), Thiscall, cocos2d::extension::CCScale9Sprite)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::extension::CCScale9Sprite::setOpacity)), Thiscall, cocos2d::extension::CCScale9Sprite, setOpacity, GLubyte)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::extension::CCScale9Sprite::updateDisplayedOpacity)), Thiscall, cocos2d::extension::CCScale9Sprite, updateDisplayedOpacity, GLubyte)
